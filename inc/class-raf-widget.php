...
class RAF_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array(
			'classname' => 'raf_widget raf_link',
			'description' => esc_html__( 'Add a recommend to a friend widget' , 'raf' ),
		);
		parent::__construct( 'recommend_a_friend', 'Recommend to a Friend', $widget_ops );
	}
